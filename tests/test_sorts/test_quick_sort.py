...
class TestStringMethods(unittest.TestCase):
    ...
    def test_basic_int_array_quick_sort(self):
        array = self.basic_int_array
        length = len(array)
        result = self.result_for_basic_int_array
        self.assertEqual(quick_sort(array, 0, length - 1), result)


    def test_basic_float_array_quick_sort(self):
    ...
    def test_single_array_quick_sort(self):
    ...
    def test_empty_array_quick_sort(self):
        array = self.empty_array
        length = len(array)
        self.assertEqual(quick_sort(array, 0, length - 1), EMPTY_LIST)
